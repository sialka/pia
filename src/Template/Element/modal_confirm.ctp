...
$('a[data-confirm]').click(function(e){
    ...
    if(!$('#confirm-delete').length){
        ...
        modal = modal + '<div class="modal-content"><div class="modal-header bg-primary text-white">';
        ...
        modal = modal + '<a class="btn btn-success no-radius normal" id="dataConfirmOK">';
        modal = modal + '<i class="fa fa-check"></i> Confirmar</a>';
        modal = modal + '<button type="button" class="btn btn-link no-link normal" data-dismiss="modal">';
