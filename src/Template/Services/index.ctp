            ...
            <div class="card-body">
              ...
              <div class="row text-center">              
                  <div class="col-4 mt-1 p-1">
                    <a link="#" id="less-ficha" class="btn btn-block btn-danger text-white" style="font-size: 0.9rem">-</a>
                  </div>
                  <div class="col-4 mt-1 p-1">
                    <button type="submit" class="btn btn-block btn-primary" style="font-size: 0.9rem">Chamar</button>
                  </div>
                  <div class="col-4 mt-1 p-1">
                    <a link="#" id="plus-ficha" class="btn btn-block btn-success text-white" style="font-size: 0.9rem">+</a>                          
                  </div>              
              </div>
              <?= $this->Form->end() ?>
            </div>
        ...
        <div class="col-12 pl-4 pr-4">
          <div class="card shadow border-1">
            ...
            <div class="card-body">
              ...
              <div class="row text-center">              
                  <div class="col-4 mt-1 p-1">
                    <a link="#" id="less-reserva" class="btn btn-block btn-danger text-white" style="font-size: 0.9rem">-</a>
                  </div>
                  <div class="col-4 mt-1 p-1">
                    <button type="submit" class="btn btn-block btn-primary" style="font-size: 0.9rem">Chamar</button>
                  </div>
                  <div class="col-4 mt-1 p-1">
                    <a link="#" id="plus-reserva" class="btn btn-block btn-success text-white" style="font-size: 0.9rem">+</a>                          
                  </div>              
              </div>
              <?= $this->Form->end() ?>
            </div>
    ...
    <div class="col-9 pr-5">   
      ...
      <div class="row">  
        <div class="col-12">
          ...
          <a class="btn btn-primary no-radius ml-1" href="#" data-toggle="modal" data-target="#modalResumo">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header bg-success text-white p-3">
                    <h5 class="modal-title" id="exampleModalLabel">Resumo dos Atendimentos</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                      <label for="report" class="strong">Resumo:</label>
                      <textarea class="form-control no-radius w-100 text-left" rows="5" id="report">
                      <?php
                      echo "\n";
                      echo "*Reunião da Pidade:* 01/08/2024 \n";
                      echo "\n*Resumo de Fichas/Envelopes Conferidos*\n";
                      echo "- Bairro dos Pimentas: Fichas OK - Envelopes OK \n";
                      echo "- Jardim Angélica: Fichas OK - Envelopes OK \n";
                      ?>
                      </textarea>
                    </div>
                ...
                <div class="modal-footer bg-footer p-1">                                             
                    <button type="button" class="btn btn-link no-link text-primary" data-dismiss="modal">
