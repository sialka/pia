...
<div class="container-row">
    ...
    <div class="row p-5 m-0 mobile-hide">
            ...
            <div class="ml-4">  
                  ...
                  <div class="card border-left-primary shadow h-100">                      
                    <div class="card-body p-3">                        
                        <div class="d-flex justify-content-between pt-1">
                            <div class="font-weight-bold text-primary text-uppercase dash-card">LOCALIDADES</div>                            
              ...
              <div class="col-12 p-0 mb-2">
                <div class="card border-left-success shadow h-100">                        
                  <div class="card-body p-3">                                                        
                      <div class="d-flex justify-content-between pt-1">
                          <div class="font-weight-bold text-success text-uppercase dash-card">CONFERÊNCIA DE FICHAS</div>
                          <div class="h1 font-weight-bold text-gray-800"><?= $total_senhas; ?></div>                                
                      </div>                                
                      <div class="d-flex justify-content-between pt-1">
                        <div class="mb-0 mr-3 font-weight-bold text-lg text-gray-800">Conferidas: </div>
              ...
              <div class="col-12 p-0 mb-2">                    
                <div class="card border-left-info shadow h-100">                        
                  <div class="card-body p-3">                                                        
                      <div class="d-flex justify-content-between pt-1">
                          <div class="font-weight-bold text-info text-uppercase dash-card">RESERVAS</div>
                          <div class="h1 font-weight-bold text-gray-800"><?= $total_senhas; ?></div>                                
                      </div>                                
                      <div class="d-flex justify-content-between pt-1">
            ...
            <div class="ml-4">       
              ...
              <div class="col-12 p-0 mb-2">
                  <div class="card border-left-primary shadow h-100">                      
                    <div class="card-body p-3">                              
                        <div class="d-flex justify-content-between pt-1">
                            <div class="dash-card font-weight-bold text-primary text-uppercase">ÚLTIMA SENHA CONFERÊNCIA DE FICHA</div>                            
              ...
              <div class="col-12 p-0 mb-2">
                <div class="card border-left-success shadow h-100">                        
                  <div class="card-body p-3">                                                        
                      <div class="d-flex justify-content-between pt-1">
                          <div class="dash-card font-weight-bold text-success text-uppercase">ÚLTIMA SENHA RESERVA</div>
              ...
              <div class="col-12 p-0 mb-2">                    
                <div class="card border-left-info shadow h-100">                        
                  <div class="card-body p-3">                                                        
                      <div class="d-flex justify-content-between pt-1">
                          <div class="dash-card font-weight-bold text-info text-uppercase">CONFERÊNCIA DE ENVELOPES</div>                      
                      </div>
                      <div class="dash-value font-weight-bold text-gray-800 text-right"><?= $panels3; ?></div>                                
                  </div> 
                </div>                    
              </div>
              ...
              <div class="col-12 p-0 mb-0">                    
                <div class="card border-left-warning shadow h-100">                        
                  <div class="card-body p-3">                                                        
                      <div class="d-flex justify-content-between pt-1">
                          <div class="dash-card font-weight-bold text-warning text-uppercase">ATENDIMENTO ENVELOPES</div>                          
                      </div>
                      <div class="dash-value font-weight-bold text-gray-800 text-right"><?= $panels4; ?></div>                                
                  </div> 
                </div>                    
              </div>
