...
INSERT INTO `users` (`id`, `nome`, `username`, `email`, `password`, `mod_user`, `mod_localidade`, `mod_setores`, `mod_atendimento`,`status`, `created`, `modified`) VALUES
(1, 'Sistema', 'sistema', 'sialkas@gmail.com', '$2y$10$OlQdL/TfLoCAZGqV9hI0Geu3/MfaDmhTnl13VqqFRfv9biSNgdN86', false, false, false, false, true, NULL, NULL),
COMMIT;
